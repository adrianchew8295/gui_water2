...
# 職責: QQQ / 美股 0DTE 智能期權實戰座艙 (防呆鎖定機制 · 局部無感刷新 · 5M換棒倒數 · Greeks儀表盤 · 1:2結構風控)
...
def analyze_0dte_tactical(df_5m: pd.DataFrame, df_day: pd.DataFrame, target_code: str = "US.QQQ", budget_usd: float = 200.0):
    """0DTE 量化定罪大腦：防呆狀態鎖定、空間邊界、2B 假突破、ATM 行權價、Greeks 與 1:2 風控"""
