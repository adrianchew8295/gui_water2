# 文件名: app.py
# 職責: GUI Water 總裝主入口 · 支援 URL query_params 路由記憶 (F5 刷新不跳回首頁)
...
# URL query_params 路由持久化 (徹底解決 F5 跳回首頁問題)
url_tab = st.query_params.get("tab", "0dte" if "tab" in st.query_params else "qqq")
